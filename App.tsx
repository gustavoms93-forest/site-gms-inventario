        ...
        <div className="w-full lg:w-7/12 px-6 md:px-12 py-16 lg:py-24 flex flex-col justify-center relative z-10 bg-white">
          ...
          >
            ...
            <p className="text-lg text-slate-600 mb-8 leading-relaxed max-w-xl">
              Desenvolvido a partir de anos de experiência em campo com inventários florestais, nosso aplicativo foi criado sob medida para atender às reais demandas dos profissionais da área. Ele oferece mais rapidez na coleta de dados, funcionamento offline eficiente e processamento seguro das informações, tornando o inventário florestal mais ágil, preciso e organizado.
            </p>
      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="space-y-3">
            <a 
              href="https://www.instagram.com/gmsinventario?igsh=MWl6d2djcTM1ODZ6YQ==" 
              target="_blank" 
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="https://www.linkedin.com/company/gms-florestal" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center hover:bg-brand-blue-50 text-slate-400 hover:text-brand-blue-600 transition-colors font-bold text-sm">
                in
              </a>
              <a href="https://www.instagram.com/gmsinventario?igsh=MWl6d2djcTM1ODZ6YQ==" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center hover:bg-brand-blue-50 text-slate-400 hover:text-brand-blue-600 transition-colors font-bold text-sm">
                ig
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 font-medium text-sm flex flex-col items-start">
              ...
              <li className="w-full">
                <button 
                  ...
                  className="flex items-center gap-1.5 hover:text-brand-blue-600 transition-colors outline-none"
                >
                  Contato
                  <ChevronDown className={`w-3.5 h-3.5 transition-transform duration-200 ${contactOpen ? 'rotate-180 text-brand-blue-600' : 'text-slate-400'}`} />
                </button>
                <AnimatePresence>
                  {contactOpen && (
                    <motion.div
                    ...
                    >
                      <div className="pt-3 pb-1 space-y-3 pl-3 border-l-[1.5px] border-slate-100 ml-1 mt-1">
                        <a href="mailto:gmsflorestal+suporte@gmail.com" className="flex items-center gap-2 hover:text-brand-blue-600 transition-colors group">
                          <Mail className="w-3.5 h-3.5 text-slate-400 group-hover:text-brand-blue-600 transition-colors" />
                          <span className="truncate">gmsflorestal<wbr/>+suporte<wbr/>@gmail.com</span>
                        </a>
                        <a href="https://wa.me/5589994673037" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-brand-blue-600 transition-colors group">
                          <Phone className="w-3.5 h-3.5 text-slate-400 group-hover:text-brand-blue-600 transition-colors" />
                          <span>(89) 99467-3037</span>
                        </a>
                      </div>
                    </motion.div>
                  )}
              ...
              <li><Link to="/termos" className="hover:text-brand-blue-600 transition-colors">Termos de Uso</Link></li>
              <li><Link to="/privacidade" className="hover:text-brand-blue-600 transition-colors">Política de Privacidade</Link></li>
            </ul>
          </div>
        </div>
