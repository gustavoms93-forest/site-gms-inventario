        ...
        <div className="w-full lg:w-7/12 px-6 md:px-12 py-16 lg:py-24 flex flex-col justify-center relative z-10 bg-white">
          ...
          >
            ...
            <p className="text-lg text-slate-600 mb-8 leading-relaxed max-w-xl">
              Desenvolvemos um app robusto com base em anos de experiência em campo, feito sob medida para atender à sua demanda. Ele garante rapidez na coleta, funcionamento offline impecável e processamento de dados seguro para acelerar o seu inventário florestal.
            </p>
